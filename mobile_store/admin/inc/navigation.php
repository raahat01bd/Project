              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/purchase" class="nav-link nav-maintenance_purchase">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=purchase_returns" class="nav-link nav-purchase returns">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/Returns" class="nav-link nav-maintenance_Returns">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Customers Returns
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/damage" class="nav-link nav-maintenance_damage">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Damage Products
                        </p>
